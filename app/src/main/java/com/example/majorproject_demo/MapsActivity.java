...
public class MapsActivity extends FragmentActivity implements
   ...
   private String[] arrSplit1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrSplit=Buses_Activity.sd.split(",");
        arrSplit1=Buses_Activity.dd.split(",");
        Toast.makeText(MapsActivity.this,""+arrSplit[0]+" "+arrSplit[1],Toast.LENGTH_LONG).show();
         loc1 = new LatLng(Double.parseDouble(arrSplit[0]),Double.parseDouble(arrSplit[1]));
         loc2 = new LatLng(Double.parseDouble(arrSplit1[0]),Double.parseDouble(arrSplit1[1]));
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        mMap.addPolyline((new PolylineOptions()).add(loc1,loc2).
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(loc1, 15));
